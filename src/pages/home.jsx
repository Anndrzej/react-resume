  ...
  return (
    <Box component='main'>
      ...
      <div className={css.wrp}>
        <p className={css.text}>Hi! Welcome to my portfolio page. My name is Andrzej and i'm currently looking for a job as a Front-End developer. Feel free to let me know by the links below or by the <Link className={css.link} to='/contacts'>contact page</Link>  if you are interested in my candidature.</p>
